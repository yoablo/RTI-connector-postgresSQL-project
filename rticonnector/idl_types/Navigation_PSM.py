...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Navigation_Resource"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_motionLimitSourceID": [
            idl.id(14569655),
        ],
        "A_specificationSourceID": [
            idl.id(221192984),
        ],
        "A_selectedDatumSourceID": [
            idl.id(139296669),
        ],
...
class P_Navigation_PSM_C_Navigation_Resource:
    ...
    A_resourceType: P_Navigation_PSM.T_NavResource = (
        P_Navigation_PSM.T_NavResource.L_NavResource_COMPASS_ONLY
    )
    A_northReference: P_Navigation_PSM.T_HeadingRefDatum = (
        P_Navigation_PSM.T_HeadingRefDatum.L_HeadingRefDatum_MAGNETIC
    )
    ...
    A_resourceInputSourceID: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_motionLimitSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_specificationSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_selectedDatumSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_angularMotionSourceID: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_attitudeSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_headingSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_linearMotionSourceID: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_frameVelocitySourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_positionSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_gpsCriticalFailure": [
            idl.id(7769737),
        ],
        "A_numberOfSatellites": [
            idl.id(47576042),
        ],
        "A_figureOfMerit": [
            idl.id(47361394),
...
class P_Navigation_PSM_C_GPS_Receiver:
    ...
    A_gpsKeyStatus: P_Navigation_PSM.T_GpsKeyStatus = (
        P_Navigation_PSM.T_GpsKeyStatus.L_GpsKeyStatus_KEY_REQUIRED
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Inertial_Nav_System"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_positionFixReceived": [
            idl.id(187661184),
        ],
        "A_positionFixAccepted": [
            idl.id(23830193),
        ],
        "A_zuptRequest": [
            idl.id(186245124),
        ],
        "A_insCriticalFailure": [
            idl.id(250149265),
        ],
        "A_odometerNotCompatible": [
            idl.id(42296514),
        ],
        "A_positionError": [
            idl.id(174661909),
        ],
        "A_insTimeToReadiness": [
            idl.id(196783252),
        ],
        "A_insModeStatus": [
            idl.id(204655139),
...
class P_Navigation_PSM_C_Inertial_Nav_System:
    ...
    A_alignTimeToGo: P_LDM_Common.T_Duration = field(
    ...
    A_positionError: float = 0.0
    A_insTimeToReadiness: P_LDM_Common.T_Duration = field(
        default_factory=P_LDM_Common.T_Duration
    )
    A_insModeStatus: P_Navigation_PSM.T_ModeState = (
        P_Navigation_PSM.T_ModeState.L_ModeState_INITIALIZING
    )
...
class P_Navigation_PSM_C_Position:
    ...
    A_currentPosition: P_LDM_Common.T_Coordinate3D = field(
...
class P_Navigation_PSM_C_Attitude:
    ...
    A_sensorAttitude: P_LDM_Common.T_Attitude = field(
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Res_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_worldMagModelSupport": [
            idl.id(32340622),
        ],
        "A_supportOutputSourceID": [
            idl.id(195793017),
        ],
        "A_supportSetupSourceID": [
            idl.id(262867245),
        ],
    },
)
class P_Navigation_PSM_C_Nav_Res_Specification:
    ...
    A_supportOutputSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_supportSetupSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Res_Attitude_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_Res_Attitude_Specification = (
    P_Navigation_PSM_C_Nav_Res_Attitude_Specification
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_PositionUncertainty"),
    ],
    member_annotations={
        "A_positionUncertainty": [
            idl.id(1605410),
        ],
        "A_positionUncertaintyValue": [
            idl.id(254759515),
        ],
        "A_heightUncertainty": [
            idl.id(81183808),
        ],
        "A_heightUncertaintyValue": [
            idl.id(174727286),
        ],
    },
)
class P_Navigation_PSM_C_PositionUncertainty(P_Navigation_PSM.C_Position):
    A_positionUncertainty: P_Navigation_PSM.T_Uncertainty = (
        P_Navigation_PSM.T_Uncertainty.L_Uncertainty_GDOP
    )
    A_positionUncertaintyValue: float = 0.0
    A_heightUncertainty: P_Navigation_PSM.T_Uncertainty = (
        P_Navigation_PSM.T_Uncertainty.L_Uncertainty_GDOP
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Motion_Limit_Setting"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_pitchRateExceedance": [
            idl.id(35818924),
        ],
        "A_rollRateExceedance": [
            idl.id(202574286),
        ],
        "A_yawRateExceedance": [
            idl.id(229511805),
        ...
        "A_pitchAccelExceedance": [
            idl.id(73677718),
        ],
        "A_rollAccelExceedance": [
            idl.id(41445025),
        ],
        "A_yawAccelExceedance": [
            idl.id(67692584),
        ],
        "A_xAxisVelocityLimit": [
            idl.id(233330941),
        ],
        "A_yAxisVelocityLimit": [
            idl.id(143926475),
        ],
        "A_zAxisVelocityLimit": [
            idl.id(111466450),
        ],
        "A_xAxisVelocityExceed": [
            idl.id(75779922),
        ],
        "A_yAxisVelocityExceed": [
            idl.id(99176088),
        ],
        "A_zAxisVelocityExceed": [
            idl.id(60695735),
        ],
        "A_xAxisAccelLimit": [
            idl.id(12141822),
        ...
        "A_xAxisAccelExceedance": [
            idl.id(193596986),
        ],
        "A_yAxisAccelExceedance": [
            idl.id(2143107),
        ],
        "A_zAxisAccelExceedance": [
            idl.id(26513007),
        ],
        "A_pitchAngleLimit": [
            idl.id(79217714),
        ],
        "A_pitchAngleExceedance": [
            idl.id(168221596),
        ],
        "A_rollAngleLimit": [
            idl.id(3053779),
        ],
        "A_rollAngleExceedance": [
            idl.id(117737275),
        ],
    },
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Navigation_Frame_Velocity"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Navigation_Frame_Velocity = (
    P_Navigation_PSM_C_Navigation_Frame_Velocity
)
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_platformFrameVelocity": [
            idl.id(203088002),
        ],
        "A_platformFrameAccel": [
            idl.id(252667915),
        ],
        "A_axis": [
            idl.id(38414735),
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Install_Align_Setting"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_installationOffset": [
            idl.id(248008378),
        ],
        "A_installationAttitude": [
            idl.id(225390158),
        ],
    },
)
class P_Navigation_PSM_C_Install_Align_Setting:
    ...
    A_installationOffset: P_LDM_Common.T_LinearOffset = field(
        default_factory=P_LDM_Common.T_LinearOffset
    )
    A_installationAttitude: P_LDM_Common.T_Attitude = field(
        default_factory=P_LDM_Common.T_Attitude
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Res_Output_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_platformVelocitySupport": [
            idl.id(106146439),
        ],
        "A_navigationVelocitySupport": [
            idl.id(153799713),
        ],
        "A_posUncertaintySupport": [
            idl.id(181375069),
        ],
        "A_heightSupport": [
            idl.id(149293336),
        ],
        "A_heightUncertaintySupport": [
            idl.id(91277288),
        ],
        "A_dateSupport": [
            idl.id(267491668),
        ...
        "A_platformAccelSupport": [
            idl.id(36243438),
        ],
        "A_distCalcSinceSystemReady": [
            idl.id(61325987),
        ],
    },
)
...
P_Navigation_PSM.C_Nav_Res_Output_Specification = (
    P_Navigation_PSM_C_Nav_Res_Output_Specification
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Res_Setup_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_setPositionSupport": [
            idl.id(210401564),
        ],
        "A_setNorthReferenceSupport": [
            idl.id(121888719),
        ],
        "A_setCoordSystemSupport": [
            idl.id(42483439),
        ],
        "A_installAlignmentSupport": [
            idl.id(31529420),
        ],
        "A_limitsSupport": [
            idl.id(9099665),
        ],
        "A_setDataOutputRatesSupport": [
            idl.id(224237084),
        ],
        "A_keyedGpsSupport": [
            idl.id(58700755),
...
P_Navigation_PSM.C_Nav_Res_Setup_Specification = (
    P_Navigation_PSM_C_Nav_Res_Setup_Specification
)
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_angularAccelAboutAxis": [
            idl.id(20220794),
        ],
        "A_angularVelocityAboutAxis": [
            idl.id(91215792),
        ],
        "A_axis": [
            idl.id(38414735),
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Coord_System_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Navigation_PSM_C_Coord_System_Specification:
    ...
    A_coordinateSystemTypeName: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )


P_Navigation_PSM.C_Coord_System_Specification = (
    P_Navigation_PSM_C_Coord_System_Specification
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Coord_Datum_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Navigation_PSM_C_Coord_Datum_Specification:
    ...
    A_coordinateDatumTypeName: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_selectedNavResSourceID: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_navResSpecificationSourceID: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_coordSysSpecificationSourceID: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )


P_Navigation_PSM.C_Coord_Datum_Specification = (
    P_Navigation_PSM_C_Coord_Datum_Specification
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Platform_Mobility_State"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_angularVelocityXComponent": [
            idl.id(226565320),
        ],
        "A_angularVelocityYComponent": [
            idl.id(118196319),
        ],
        "A_angularVelocityZComponent": [
            idl.id(8685478),
        ],
    },
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Aligment_Survey_Status"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Navigation_PSM_C_Aligment_Survey_Status:
    ...
    A_mode: P_Navigation_PSM.T_AlignMode = (
        P_Navigation_PSM.T_AlignMode.L_AlignMode_NORMAL_ALIGN
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_GridConvergeReq_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_Resource_GridConvergeReq_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_GridConvergeReq_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_MagnVariationReq_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_Resource_MagnVariationReq_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_MagnVariationReq_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_SetMagnVariation_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_Resource_SetMagnVariation_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_SetMagnVariation_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_SetUTC_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Navigation_PSM_C_Nav_Resource_SetUTC_Cmd:
    ...
    A_timeOfDay: P_LDM_Common.T_DateTime = field(
        default_factory=P_LDM_Common.T_DateTime
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_SetZuptMode_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_Resource_SetZuptMode_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_SetZuptMode_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_SetDataOutRate_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_Resource_SetDataOutRate_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_SetDataOutRate_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_SetCoordSystem_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_coordDatumTypeName": [
            idl.id(208920108),
        ],
        "A_coordSystemTypeName": [
            idl.id(116612161),
        ],
    },
)
class P_Navigation_PSM_C_Nav_Resource_SetCoordSystem_Cmd:
    ...
    A_coordDatumTypeName: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_coordSystemTypeName: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )


P_Navigation_PSM.C_Nav_Resource_SetCoordSystem_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_SetCoordSystem_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_Resource_SetNorthRef_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Navigation_PSM_C_Nav_Resource_SetNorthRef_Cmd:
    ...
    A_datum: P_Navigation_PSM.T_HeadingRefDatum = (
        P_Navigation_PSM.T_HeadingRefDatum.L_HeadingRefDatum_MAGNETIC
    )


P_Navigation_PSM.C_Nav_Resource_SetNorthRef_Cmd = (
    P_Navigation_PSM_C_Nav_Resource_SetNorthRef_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_System_StoreHeadingAlign_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Nav_System_StoreHeadingAlign_Cmd = (
    P_Navigation_PSM_C_Nav_System_StoreHeadingAlign_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Magnetometer_Calibrate_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Magnetometer_Calibrate_Cmd = (
    P_Navigation_PSM_C_Magnetometer_Calibrate_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Odometer_ResetDistance_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Odometer_ResetDistance_Cmd = (
    P_Navigation_PSM_C_Odometer_ResetDistance_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Position_SetUncertaintyTypes_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Position_SetUncertaintyTypes_Cmd = (
    P_Navigation_PSM_C_Position_SetUncertaintyTypes_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Position_SetCurrentPosition_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Navigation_PSM_C_Position_SetCurrentPosition_Cmd:
    ...
    A_position: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )


P_Navigation_PSM.C_Position_SetCurrentPosition_Cmd = (
    P_Navigation_PSM_C_Position_SetCurrentPosition_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Heading_SetCurrentHeading_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Heading_SetCurrentHeading_Cmd = (
    P_Navigation_PSM_C_Heading_SetCurrentHeading_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Motion_Limit_SetPitchRollLimit_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Motion_Limit_SetPitchRollLimit_Cmd = (
    P_Navigation_PSM_C_Motion_Limit_SetPitchRollLimit_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Motion_Limit_SetLinearAccLimit_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Motion_Limit_SetLinearAccLimit_Cmd = (
    P_Navigation_PSM_C_Motion_Limit_SetLinearAccLimit_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Motion_Limit_SetVelocityLimit_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Motion_Limit_SetVelocityLimit_Cmd = (
    P_Navigation_PSM_C_Motion_Limit_SetVelocityLimit_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Motion_Limit_SetAngulAccLimit_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Motion_Limit_SetAngulAccLimit_Cmd = (
    P_Navigation_PSM_C_Motion_Limit_SetAngulAccLimit_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Motion_Limit_SetAngRateLimit_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Motion_Limit_SetAngRateLimit_Cmd = (
    P_Navigation_PSM_C_Motion_Limit_SetAngRateLimit_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Install_Align_SetInstallOffset_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Install_Align_SetInstallOffset_Cmd = (
    P_Navigation_PSM_C_Install_Align_SetInstallOffset_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Install_Align_SetInstAttitude_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Navigation_PSM.C_Install_Align_SetInstAttitude_Cmd = (
    P_Navigation_PSM_C_Install_Align_SetInstAttitude_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_System_Realign_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Navigation_PSM::C_Nav_GPS_Connect_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
