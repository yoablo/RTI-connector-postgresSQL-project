...
P_LDM_Common.T_AngularAcceleratInRadPerSec2 = P_LDM_Common_T_AngularAcceleratInRadPerSec2
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_LDM_Common::T_Covariance_Coordinate3D")],
    member_annotations = {
        'A_altitude_latitude': [idl.id(200386494), ],
        'A_latitude_longitude': [idl.id(187768712), ],
        'A_longitude_altitude': [idl.id(64158173), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_elevation_azimuth': [idl.id(201093986), ],
        'A_azimuth_range': [idl.id(66183831), ],
        'A_range_elevation': [idl.id(132898885), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_pitch': [idl.id(234084394), ],
        'A_roll': [idl.id(37030839), ],
        'A_yaw': [idl.id(174145604), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_xOffset': [idl.id(155543010), ],
        'A_yOffset': [idl.id(100746606), ],
        'A_zOffset': [idl.id(158238848), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_pitchOffset': [idl.id(170002966), ],
        'A_rollOffset': [idl.id(86270452), ],
        'A_yawOffset': [idl.id(2406003), ],
    }
)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_LDM_Common::T_PixelsVideoPosition")],
    member_annotations = {
        'A_verticalPosition': [idl.id(211066011), ],
        'A_horizontalPosition': [idl.id(83622824), ],
    }
...
@idl.struct(
    ...
    member_annotations = {
        'A_vertical': [idl.id(73630748), ],
        'A_horizontal': [idl.id(205819821), ],
    }
)
