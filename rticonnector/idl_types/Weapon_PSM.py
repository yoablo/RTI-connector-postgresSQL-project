...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::T_LoaderAmmunitionState"),
    ],
    member_annotations={
        "A_ammunitionName": [
            idl.id(267068887),
        ],
        "A_loaderSequenceNumber": [
            idl.id(236004433),
        ],
        "A_ammunitionCount": [
            idl.id(177769603),
...
class P_Weapon_PSM_T_LoaderAmmunitionState:
    A_ammunitionName: P_LDM_Common.T_ShortString = field(
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::T_BalisticCompensationValue"),
    ],
    member_annotations={
        "A_traverse": [
            idl.id(39062148),
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Weapon_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_supportedAmmunitionList": [
            idl.id(71747423),
        ],
        "A_fireCorrectionSupport": [
            idl.id(213845062),
        ],
        "A_hotFireCorrectionSupport": [
            idl.id(113971641),
        ],
        "A_firingTypeSupport": [idl.id(148556402), idl.bound(3)],
        "A_burstLengthChangeSupport": [
            idl.id(60760835),
        ],
        "A_minBurstLength": [
            idl.id(50882846),
        ...
        "A_fireInhibitZoneSupport": [
            idl.id(172484004),
        ],
        "A_balisticCompensationSupport": [
            idl.id(187502423),
        ],
    },
)
class P_Weapon_PSM_C_Weapon_Specification:
    ...
    A_caliber: float = 0.0
    A_weaponName: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_supportedAmmunitionList: P_Weapon_PSM.T_ListOfWeaponAmmunitions = field(
        default_factory=P_Weapon_PSM.T_ListOfWeaponAmmunitions
    )
    A_fireCorrectionSupport: bool = False
    A_hotFireCorrectionSupport: bool = False
    A_firingTypeSupport: Sequence[P_Weapon_PSM.T_FiringType] = field(
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Weapon_Loader_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Weapon:
    ...
    A_currentAmmunition: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_currentFiringType: P_Weapon_PSM.T_FiringType = (
        P_Weapon_PSM.T_FiringType.L_FiringType_SINGLE
    )
    A_burstLength: idl.uint8 = 0
    A_isInFireInhibitZone: bool = False
    A_cockingState: P_Weapon_PSM.T_CockingState = (
        P_Weapon_PSM.T_CockingState.L_CockingState_OFF
    )
...
class P_Weapon_PSM_C_FireSemiCorrection:
    ...
    A_lastIndication: P_Weapon_PSM.T_FireSemiCorrAction = (
        P_Weapon_PSM.T_FireSemiCorrAction.L_FireSemiCorrAction_ADD
    )
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_azimuthHotCorrection": [
            idl.id(129341050),
        ],
        "A_elevationHotCorrection": [
            idl.id(146539350),
        ],
    },
)
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_fireInitiatorDescriptor": [
            idl.id(176845168),
        ],
        "A_currentAmmunition": [
            idl.id(45786869),
        ],
        "A_fireLocationAvailable": [
            idl.id(240129194),
        ],
        "A_fireLocation": [
            idl.id(38796174),
...
class P_Weapon_PSM_C_Fire_Event:
    ...
    A_fireInitiatorDescriptor: P_LDM_Common.T_VeryShortString = field(
    ...
    A_fireLocation: P_LDM_Common.T_Coordinate3D = field(
...
class P_Weapon_PSM_C_Weapon_Loaders:
    ...
    A_currentAmmunition: Sequence[P_Weapon_PSM.T_LoaderAmmunitionState] = field(
        default_factory=list
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Balistic_Parameters"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_gunPowderTemperature": [
            idl.id(229963660),
        ],
        "A_gunPowderTemperatureSource": [
            idl.id(217480135),
        ],
        "A_gunJump": [
            idl.id(56281219),
        ],
        "A_balisticCompensation": [
            idl.id(240577419),
        ],
    },
)
class P_Weapon_PSM_C_Balistic_Parameters:
    ...
    A_gunPowderTemperatureSource: P_LDM_Common.T_Value_Source = (
        P_LDM_Common.T_Value_Source.L_Value_Source_UNKNOWN
    )
    A_gunJump: P_Weapon_PSM.T_GunJumpValue = field(
        default_factory=P_Weapon_PSM.T_GunJumpValue
    )
    A_balisticCompensation: P_Weapon_PSM.T_BalisticCompensationValue = field(
        default_factory=P_Weapon_PSM.T_BalisticCompensationValue
    )
...
class P_Weapon_PSM_C_Ramp_Position:
    ...
    A_postion: P_Weapon_PSM.T_CannonAppliancePosition = (
        P_Weapon_PSM.T_CannonAppliancePosition.L_CannonAppliancePosition_NONE
    )
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_seriesAirTemperature": [
            idl.id(136679608),
        ],
        "A_seriesGunPowderTemperature": [
            idl.id(102962035),
        ],
        "A_seriesHeight": [
            idl.id(208633532),
        ],
        "A_seriesGunJumpValue": [
            idl.id(32597079),
        ],
        "A_seriesLearningValue": [
            idl.id(121558912),
        ],
        "A_accumulatedLearningValue": [
            idl.id(96934584),
        ],
        "A_endSeriesReason": [
            idl.id(21744586),
...
class P_Weapon_PSM_C_Fire_Series:
    ...
    A_seriesStartTime: P_LDM_Common.T_DateTime = field(
        default_factory=P_LDM_Common.T_DateTime
    )
    A_seriesEndTime: P_LDM_Common.T_DateTime = field(
        default_factory=P_LDM_Common.T_DateTime
    )
    A_seriesAmmunition: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_seriesRangeType: P_Weapon_PSM.T_RangeType = (
        P_Weapon_PSM.T_RangeType.L_RangeType_MANUAL
    )
    A_seriesRange: P_Weapon_PSM.T_RangeMeasurement = field(
        default_factory=P_Weapon_PSM.T_RangeMeasurement
    )
    A_seriesAirTemperature: float = 0.0
    A_seriesGunPowderTemperature: float = 0.0
    A_seriesHeight: float = 0.0
    A_seriesGunJumpValue: P_Weapon_PSM.T_GunJumpValue = field(
        default_factory=P_Weapon_PSM.T_GunJumpValue
    )
    A_seriesLearningValue: float = 0.0
    A_accumulatedLearningValue: float = 0.0
    A_endSeriesReason: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_nonLearningReason: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_elevationSemiCorrection": [
            idl.id(127370406),
        ],
        "A_traverseSemiCorrection": [
            idl.id(44615645),
        ],
        "A_sideWindVelocity": [
            idl.id(197342223),
        ],
        "A_elevationDynamicCompensation": [
            idl.id(56567334),
        ],
        "A_deflectionDynamicCompensation": [
            idl.id(103337218),
        ],
        "A_absoluteAzimuth": [
            idl.id(173265625),
        ...
        "A_shellNumberInSeries": [
            idl.id(33648210),
        ],
        "A_gunResolver": [
            idl.id(63748537),
        ],
        "A_deflectionEnslavementError": [
            idl.id(56926495),
        ],
        "A_elevationEnslavementError": [
            idl.id(16352289),
        ],
    },
)
class P_Weapon_PSM_C_FireEvent_Shell(P_Weapon_PSM.C_Fire_Event):
    ...
    A_sightEnslavement: P_LDM_Common.T_SightEnslavement_Mode = (
        P_LDM_Common.T_SightEnslavement_Mode.L_SightEnslavement_Mode_IDLE
    )
    A_trackState: bool = False
    A_trackID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    ...
    A_sideWindVelocity: P_LDM_Common.T_Vector_3D = field(
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_FireSemiCorrection_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_FireSemiCorrection_Cmd:
    ...
    A_requestedCorrection: P_Weapon_PSM.T_FireSemiCorrAction = (
        P_Weapon_PSM.T_FireSemiCorrAction.L_FireSemiCorrAction_ADD
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_FireHotCorrection_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_SetAmmunition_Cmd:
    ...
    A_requestedAmmunition: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_SetAmmunitionList_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_SetAmmunitionList_Cmd:
    ...
    A_supportedAmmunitionsList: P_Weapon_PSM.T_ListOfWeaponAmmunitions = field(
        default_factory=P_Weapon_PSM.T_ListOfWeaponAmmunitions
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Firing_Type_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Set_Firing_Type_Cmd:
    ...
    A_firingType: P_Weapon_PSM.T_FiringType = (
        P_Weapon_PSM.T_FiringType.L_FiringType_SINGLE
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Burst_Length_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Projectiles_Rate_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Ammunition_Loader_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Set_Ammunition_Loader_Cmd:
    ...
    A_loaderAmmunition: P_Weapon_PSM.T_LoaderAmmunitionState = field(
        default_factory=P_Weapon_PSM.T_LoaderAmmunitionState
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Balistic_Parameters_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Set_Balistic_Parameters_Cmd:
    ...
    A_windDirection: P_LDM_Common.T_CoordinatePolar3D = field(
...
class P_Weapon_PSM_C_Set_GunJump_Cmd:
    ...
    A_jump: P_Weapon_PSM.T_GunJumpValue = field(
        default_factory=P_Weapon_PSM.T_GunJumpValue
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Ballistic_Compensation_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Set_Ballistic_Compensation_Cmd:
    ...
    A_compensation: P_Weapon_PSM.T_BalisticCompensationValue = field(
        default_factory=P_Weapon_PSM.T_BalisticCompensationValue
    )


P_Weapon_PSM.C_Set_Ballistic_Compensation_Cmd = (
    P_Weapon_PSM_C_Set_Ballistic_Compensation_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_Ammuntion_List_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Set_Ammuntion_List_Cmd:
    ...
    A_weaponAmmunition: Sequence[P_Weapon_PSM.T_Ammunition] = field(
        default_factory=list
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Weapon_PSM::C_Set_FCS_Computing_Mode_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Weapon_PSM_C_Set_FCS_Computing_Mode_Cmd:
    ...
    A_parameterType: P_Weapon_PSM.T_FCS_Parameter = (
        P_Weapon_PSM.T_FCS_Parameter.L_FCS_Parameter_WIND_SPEED
    )
