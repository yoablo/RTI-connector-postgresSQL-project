...
@idl.struct(
    ...
    member_annotations = {
        'A_hatchIdNumber': [idl.id(119323304), ],
        'A_hatchState': [idl.id(198448767), ],
    }
)
class P_Platform_PSM_T_HatchStatus:
    A_hatchIdNumber: idl.uint8 = 0
    A_hatchState: P_Platform_PSM.T_HatchState = P_Platform_PSM.T_HatchState.L_HatchState_OPEN
...
@idl.struct(
    ...
    member_annotations = {
        'A_lightsIdNumber': [idl.id(134658096), ],
        'A_lightsState': [idl.id(20658126), ],
    }
)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::T_DeviceInformation")],
    member_annotations = {
        'A_idNumber': [idl.id(106058244), ],
        'A_descriptor': [idl.id(52732520), ],
    }
)
class P_Platform_PSM_T_DeviceInformation:
    A_idNumber: idl.uint8 = 0
    A_descriptor: P_LDM_Common.T_VeryShortString = field(default_factory = P_LDM_Common.T_VeryShortString)

P_Platform_PSM.T_DeviceInformation = P_Platform_PSM_T_DeviceInformation

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Systems_Specification")],
    member_annotations = {
        ...
        'A_platformType': [idl.id(23982935), ],
        'A_platformSubType': [idl.id(9101197), ],
        'A_fcsSupport': [idl.id(252838819), ],
        'A_fcsType': [idl.id(70507212), ],
        'A_apsSupport': [idl.id(134940479), ],
    }
)
class P_Platform_PSM_C_Platform_Systems_Specification:
    ...
    A_hatchesInformation: Sequence[P_Platform_PSM.T_DeviceInformation] = field(default_factory = list)
    A_lightsInformation: Sequence[P_Platform_PSM.T_DeviceInformation] = field(default_factory = list)
    A_platformType: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
...
P_Platform_PSM.C_Platform_Systems_Specification = P_Platform_PSM_C_Platform_Systems_Specification
...
class P_Platform_PSM_C_Platform_State:
    ...
    A_platformSubType: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_operationalMode: P_Platform_PSM.T_PlatformMode = P_Platform_PSM.T_PlatformMode.L_PlatformMode_OPERATION

P_Platform_PSM.C_Platform_State = P_Platform_PSM_C_Platform_State

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Spatial_Status")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_platformAttitude': [idl.id(258980669), ],
        'A_platformBearing': [idl.id(173478804), ],
...
class P_Platform_PSM_C_Platform_Spatial_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_platformAttitude: P_LDM_Common.T_Attitude = field(default_factory = P_LDM_Common.T_Attitude)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Environment_Parameters")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        ...
        'A_airPollution': [idl.id(170607418), ],
        'A_visibility': [idl.id(60271523), ],
        'A_lightingIntensity': [idl.id(177878861), ],
    }
)
...
P_Platform_PSM.C_Platform_Environment_Parameters = P_Platform_PSM_C_Platform_Environment_Parameters

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Internal_Parameters")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_temperature': [idl.id(242883168), ],
        'A_humidity': [idl.id(40463860), ],
        'A_airPressure': [idl.id(157462497), ],
    }
)
...
P_Platform_PSM.C_Platform_Internal_Parameters = P_Platform_PSM_C_Platform_Internal_Parameters

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Peripherial")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Combat_Status")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_combatStatus': [idl.id(71283897), ],
        'A_currentController': [idl.id(196408582), ],
    }
)
class P_Platform_PSM_C_Platform_Combat_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_combatStatus: P_Platform_PSM.T_MissionState = P_Platform_PSM.T_MissionState.L_MissionState_MOVING_TOWARD_CONTACT
    A_currentController: P_Platform_PSM.T_CombatStateController = P_Platform_PSM.T_CombatStateController.L_CombatStateController_COMMANDER

P_Platform_PSM.C_Platform_Combat_Status = P_Platform_PSM_C_Platform_Combat_Status

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Platform_Commands_Response")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
...
P_Platform_PSM.C_Platform_Commands_Response = P_Platform_PSM_C_Platform_Commands_Response

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Set_Operational_Mode_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Platform_PSM::C_Force_Manual_Control_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
        ...
        'A_manualControl': [idl.id(12790092), ],
    }
)
