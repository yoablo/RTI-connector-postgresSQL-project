...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::T_DeviceInformation")],
    member_annotations = {
...
@idl.struct(
    ...
    member_annotations = {
        'A_batteryIdNumber': [idl.id(31436872), ],
        'A_batteryState': [idl.id(246937528), ],
        'A_batteryPercent': [idl.id(47970354), ],
        'A_batteryVoltage': [idl.id(217129192), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_fuelTankIdNumber': [idl.id(230380499), ],
        'A_fuelTankAmount': [idl.id(133194151), ],
    }
)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::C_Automotive_Systems_Specification")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_numberOfTransmisionGears': [idl.id(73688494), ],
...
class P_Automotive_PSM_C_Automotive_Systems_Specification:
    ...
    A_batteryInformation: Sequence[P_Automotive_PSM.T_DeviceInformation] = field(default_factory = list)
    A_fuelTankInformation: Sequence[P_Automotive_PSM.T_DeviceInformation] = field(default_factory = list)

P_Automotive_PSM.C_Automotive_Systems_Specification = P_Automotive_PSM_C_Automotive_Systems_Specification

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::C_Automotive_Engine_State")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
...
class P_Automotive_PSM_C_Automotive_Engine_State:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_fualTankAmount: Sequence[P_Automotive_PSM.T_FuelTankStatus] = field(default_factory = list)
    A_batteryState: Sequence[P_Automotive_PSM.T_BatteryStatus] = field(default_factory = list)

P_Automotive_PSM.C_Automotive_Engine_State = P_Automotive_PSM_C_Automotive_Engine_State

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::C_Automotive_Transmission_State")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_gearPosition': [idl.id(130920940), ],
    }
)
...
P_Automotive_PSM.C_Automotive_Transmission_State = P_Automotive_PSM_C_Automotive_Transmission_State

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::C_Automotive_Speedometer")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::C_Automotive_Energy_Provider_Status")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_voltage': [idl.id(143020390), ],
        'A_current': [idl.id(133314179), ],
    }
)
...
P_Automotive_PSM.C_Automotive_Energy_Provider_Status = P_Automotive_PSM_C_Automotive_Energy_Provider_Status

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Automotive_PSM::C_Start_Self_Test_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
