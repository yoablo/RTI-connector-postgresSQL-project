...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_pathLocation': [idl.id(197913135), ],
        'A_pathSpeed': [idl.id(150738411), ],
    }
)
class P_APS_PSM_T_Post_Event_Info:
    ...
    A_pathLocation: P_LDM_Common.T_Coordinate3D = field(default_factory = P_LDM_Common.T_Coordinate3D)
...
@idl.struct(
    ...
    member_annotations = {
        'A_detectTime': [idl.id(66999595), ],
        'A_threatLocation': [idl.id(244204931), ],
        'A_velocity': [idl.id(208188061), ],
    }
)
class P_APS_PSM_T_ThreatPoint:
    A_detectTime: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_threatLocation: P_LDM_Common.T_Coordinate3D = field(default_factory = P_LDM_Common.T_Coordinate3D)
    A_velocity: P_LDM_Common.T_Vector_3D = field(default_factory = P_LDM_Common.T_Vector_3D)
...
@idl.struct(
    ...
    member_annotations = {
        'A_frontRight': [idl.id(161904839), ],
        'A_backRight': [idl.id(72147916), ],
        'A_backLeft': [idl.id(185670500), ],
        'A_frontLeft': [idl.id(213795472), ],
    }
)
class P_APS_PSM_T_EosStatus:
    A_frontRight: P_APS_PSM.T_AreaPropriety = P_APS_PSM.T_AreaPropriety.L_AreaPropriety_PROPER
    A_backRight: P_APS_PSM.T_AreaPropriety = P_APS_PSM.T_AreaPropriety.L_AreaPropriety_PROPER
    A_backLeft: P_APS_PSM.T_AreaPropriety = P_APS_PSM.T_AreaPropriety.L_AreaPropriety_PROPER
    A_frontLeft: P_APS_PSM.T_AreaPropriety = P_APS_PSM.T_AreaPropriety.L_AreaPropriety_PROPER
...
@idl.struct(
    ...
    member_annotations = {
        'A_parameter1': [idl.id(17918493), ],
        'A_parameter2': [idl.id(152680698), ],
        'A_parameter3': [idl.id(61940478), ],
        'A_parameter4': [idl.id(69184909), ],
        'A_parameter5': [idl.id(238164571), ],
    }
)
...
class P_APS_PSM_T_Launcher:
    A_status: P_APS_PSM.T_ComponentStatus = P_APS_PSM.T_ComponentStatus.L_ComponentStatus_FAULT
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_numberOfDefenseParameters': [idl.id(17060404), ],
        'A_defenseParametersDescriptors': [idl.id(175969785), idl.bound(32)],
        'A_numberOfScanAreas': [idl.id(40781558), ],
        'A_numberOfDefenseAreas': [idl.id(108012212), ],
        'A_numberOfSoftDefenseAreas': [idl.id(108418045), ],
    }
)
class P_APS_PSM_C_APS_Specifications:
    ...
    A_defenseParametersDescriptors: Sequence[P_LDM_Common.T_ShortString] = field(default_factory = list)
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_origin': [idl.id(132647116), ],
        'A_crossEstimation': [idl.id(198115436), ],
    }
)
class P_APS_PSM_C_Path_Info:
    ...
    A_origin: P_LDM_Common.T_Coordinate3D = field(default_factory = P_LDM_Common.T_Coordinate3D)
    A_crossEstimation: P_LDM_Common.T_Coordinate3D = field(default_factory = P_LDM_Common.T_Coordinate3D)

P_APS_PSM.C_Path_Info = P_APS_PSM_C_Path_Info

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_APS_PSM::C_Defense_Parameters_Status")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_defenseParameters': [idl.id(194084544), ],
        'A_validity': [idl.id(230047821), ],
    }
)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_APS_PSM::C_Defense_Parameters_Values")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_defenseParameters': [idl.id(194084544), ],
...
class P_APS_PSM_C_Defense_Parameters_Values:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_defenseParameters: P_APS_PSM.T_DefenseParameters = field(default_factory = P_APS_PSM.T_DefenseParameters)

P_APS_PSM.C_Defense_Parameters_Values = P_APS_PSM_C_Defense_Parameters_Values

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_APS_PSM::C_Readiness_Operational_Status")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_operationalMode': [idl.id(47535655), ],
        ...
        'A_safetyStatus': [idl.id(34709806), ],
        'A_mainSwitch': [idl.id(157490383), ],
    }
)
class P_APS_PSM_C_Readiness_Operational_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_operationalMode: P_APS_PSM.T_OperationalMode = P_APS_PSM.T_OperationalMode.L_OperationalMode_STANDBY
    ...
    A_softDefenseAreas: Sequence[P_APS_PSM.T_AreaPropriety] = field(default_factory = list)
    ...
    A_launchersStatus: Sequence[P_APS_PSM.T_ComponentStatus] = field(default_factory = list)
    A_safetyStatus: P_APS_PSM.T_SafetyStatus = P_APS_PSM.T_SafetyStatus.L_SafetyStatus_SAFE
    A_mainSwitch: P_APS_PSM.T_MainSwitchStatus = P_APS_PSM.T_MainSwitchStatus.L_MainSwitchStatus_OFF
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_responseNotRequired': [idl.id(193715237), ],
        'A_platform': [idl.id(29421584), ],
        'A_platformSubType': [idl.id(9101197), ],
    }
)
class P_APS_PSM_C_Set_Platform_Type_Cmd:
    ...
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_responseNotRequired: bool = False
    A_platform: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_platformSubType: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_responseNotRequired': [idl.id(193715237), ],
        'A_readinessMode': [idl.id(256066282), ],
    }
)
class P_APS_PSM_C_Set_Readiness_Cmd:
    ...
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_responseNotRequired: bool = False
    A_readinessMode: P_APS_PSM.T_OperationalMode = P_APS_PSM.T_OperationalMode.L_OperationalMode_STANDBY

P_APS_PSM.C_Set_Readiness_Cmd = P_APS_PSM_C_Set_Readiness_Cmd

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_APS_PSM::C_Set_DefenseParameters_Values_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
...
P_APS_PSM.C_Set_DefenseParameters_Values_Cmd = P_APS_PSM_C_Set_DefenseParameters_Values_Cmd
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_JumboID': [idl.id(17979367), ],
        'A_JumboAz': [idl.id(148856826), ],
        'A_JumboAzSTD': [idl.id(259407505), ],
        'A_JumboEl': [idl.id(159425565), ],
        'A_param': [idl.id(86364000), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_relativeAxis': [idl.id(195026304), ],
        'A_buildArea': [idl.id(67048405), ],
    }
)
class P_APS_PSM_C_Aps_Status_Extended(P_APS_PSM.C_Readiness_Operational_Status):
    ...
    A_relativeAxis: P_APS_PSM.T_RelativeAxis = P_APS_PSM.T_RelativeAxis.L_RelativeAxis_NO_CHANGE
...
@idl.struct(
    ...
    member_annotations = {
        'A_int_fr': [idl.id(131913229), ],
        'A_int_br': [idl.id(9443332), ],
        'A_int_bl': [idl.id(166679096), ],
        'A_int_fl': [idl.id(119785758), ],
        'A_ext_fr': [idl.id(114227980), ],
        'A_ext_br': [idl.id(32826569), ],
        'A_ext_bl': [idl.id(216696934), ],
        'A_ext_fl': [idl.id(33037673), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_sr_fr': [idl.id(67624852), ],
        'A_sr_fl': [idl.id(25864134), ],
        'A_sr_br': [idl.id(216229760), ],
        'A_sr_bl': [idl.id(244135086), ],
        'A_launcher_r': [idl.id(22396810), ],
        'A_launcher_l': [idl.id(57563729), ],
    }
)
...
class P_APS_PSM_C_APS_Status:
    ...
    A_status: P_APS_PSM.T_MaintActionStatus = P_APS_PSM.T_MaintActionStatus.L_MaintActionStatus_SUCCESS
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_APS_PSM::C_Calibration_APS_Status")],
    member_annotations = {
        'A_calibEos': [idl.id(65140487), ],
        'A_calibSystems': [idl.id(260072533), ],
    }
)
class P_APS_PSM_C_Calibration_APS_Status(P_APS_PSM.C_APS_Status):
    ...
    A_calibSystems: P_APS_PSM.T_CalibSystems = field(default_factory = P_APS_PSM.T_CalibSystems)
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_responseNotRequired': [idl.id(193715237), ],
        'A_operation': [idl.id(127010964), ],
        'A_maintenanceAction': [idl.id(127397250), ],
