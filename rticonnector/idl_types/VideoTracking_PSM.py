...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_VideoTracking_PSM::C_Video_Tracker_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_VideoTracking_PSM_C_Video_Tracker_Specification:
    ...
    A_trackableVideoStreamsIds: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )


P_VideoTracking_PSM.C_Video_Tracker_Specification = (
    P_VideoTracking_PSM_C_Video_Tracker_Specification
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_VideoTracking_PSM::C_Video_Tracker"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_VideoTracking_PSM_C_Video_Tracker:
    ...
    A_videoTrackerState: P_VideoTracking_PSM.T_Video_Tracker_State = (
        P_VideoTracking_PSM.T_Video_Tracker_State.L_Video_Tracker_State_OFF
    )
    A_trackedVideoStreamId: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_mountId: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_VideoTracking_PSM::C_Video_Tracker_StartLeadOn_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_VideoTracking_PSM_C_Video_Tracker_StartLeadOn_Cmd:
    ...
    A_trackVideoStreamId: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )


P_VideoTracking_PSM.C_Video_Tracker_StartLeadOn_Cmd = (
    P_VideoTracking_PSM_C_Video_Tracker_StartLeadOn_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_VideoTracking_PSM::C_Video_Tracker_StopLeadOn_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_VideoTracking_PSM.C_Video_Tracker_StopLeadOn_Cmd = (
    P_VideoTracking_PSM_C_Video_Tracker_StopLeadOn_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_VideoTracking_PSM::C_Video_Tracker_SetMountId_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_VideoTracking_PSM.C_Video_Tracker_SetMountId_Cmd = (
    P_VideoTracking_PSM_C_Video_Tracker_SetMountId_Cmd
)
