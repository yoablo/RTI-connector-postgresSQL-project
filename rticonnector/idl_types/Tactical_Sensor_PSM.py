...
P_Tactical_Sensor_PSM.T_DetectionTrackContent = (
    P_Tactical_Sensor_PSM_T_DetectionTrackContent
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Detection_Unique_Id"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.id(118386796),
...
P_Tactical_Sensor_PSM.T_Detection_Unique_Id = (
    P_Tactical_Sensor_PSM_T_Detection_Unique_Id
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Revelation_Source"),
    ],
    member_annotations={
        "A_identification": [
            idl.id(268347597),
...
class P_Tactical_Sensor_PSM_T_Revelation_Source:
    ...
    A_location: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_locationAccuracy: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Field_Of_View"),
    ],
    member_annotations={
        "A_hfov": [
            idl.id(219673437),
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_DetectingMethod"),
    ],
    member_annotations={
        "A_detectorType": [
            idl.id(81702893),
...
class P_Tactical_Sensor_PSM_T_DetectingMethod:
    ...
    A_algorithm: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Detection_Topic_Characteristic"),
    ],
    member_annotations={
        "A_detectionID": [
            idl.id(42345041),
...
class P_Tactical_Sensor_PSM_T_Detection_Topic_Characteristic:
    A_detectionID: P_Tactical_Sensor_PSM.T_Detection_Unique_Id = field(
        default_factory=P_Tactical_Sensor_PSM.T_Detection_Unique_Id
    )
    A_typeName: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )


P_Tactical_Sensor_PSM.T_Detection_Topic_Characteristic = (
    P_Tactical_Sensor_PSM_T_Detection_Topic_Characteristic
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Subunit_Status"),
    ],
    member_annotations={
        "A_subUnit": [
            idl.id(45537546),
...
class P_Tactical_Sensor_PSM_T_Subunit_Status:
    A_subUnit: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Descriptive_Parameters"),
    ],
    member_annotations={
        "A_recognizingDetectorTypes": [idl.id(164911381), idl.bound(10)],
        "A_classificationAvailable": [
            idl.id(74505323),
        ],
        "A_objectClassification": [
            idl.id(186028223),
        ],
        "A_classificationConfidence": [
            idl.id(193401693),
        ],
        "A_detectionSampleSize": [
            idl.id(238759197),
        ],
        "A_absoluteSize": [
            idl.id(141075497),
        ...
        "A_sourceLocationAccuracy": [
            idl.id(9859942),
        ],
        "A_sourceLocationCovariance": [
            idl.id(117488242),
        ],
        "A_sourceLocation": [
            idl.id(121402085),
...
class P_Tactical_Sensor_PSM_T_Descriptive_Parameters:
    A_recognizingDetectorTypes: Sequence[P_LDM_Common.T_MediumString] = field(
        default_factory=list
    )
    A_classificationAvailable: bool = False
    A_objectClassification: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    ...
    A_absoluteSize: P_LDM_Common.T_Dimension = field(
        default_factory=P_LDM_Common.T_Dimension
    )
    A_exposureDuration: P_LDM_Common.T_Duration = field(
        default_factory=P_LDM_Common.T_Duration
    )
    A_rangeMethod: P_LDM_Common.T_Value_Source = (
        P_LDM_Common.T_Value_Source.L_Value_Source_UNKNOWN
    )
    A_sourceLocationAccuracy: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_sourceLocationCovariance: P_LDM_Common.T_Covariance_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Covariance_Coordinate3D
    )
    A_sourceLocation: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )


P_Tactical_Sensor_PSM.T_Descriptive_Parameters = (
    P_Tactical_Sensor_PSM_T_Descriptive_Parameters
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Polygon_Point"),
    ],
    member_annotations={
        "A_point": [
            idl.id(248223038),
...
class P_Tactical_Sensor_PSM_T_Polygon_Point:
    A_point: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_accuracy: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Physical_Parameters"),
    ],
    member_annotations={
        "A_relativeLocationsBase": [
            idl.id(202129906),
        ],
        "A_sensorInertialLocationAvailable": [
            idl.id(160154763),
        ],
        "A_sensorInertialLocation": [
            idl.id(25381208),
        ],
        "A_relativeLocationAvailable": [
            idl.id(247777497),
        ],
        "A_rangeAvailable": [
            idl.id(260167579),
        ...
        "A_relativeLocationAccuracy": [
            idl.id(256823903),
        ],
        "A_relativeLocationCovariance": [
            idl.id(90631693),
        ],
        "A_inertialLocationAvailable": [
            idl.id(239505011),
        ],
        "A_inertialLocation": [
            idl.id(199017188),
        ],
        "A_inertialLocationAccuracy": [
            idl.id(151609059),
        ],
        "A_inertialLocationCovariance": [
            idl.id(113956340),
        ],
        "A_absoluteLocationAvailable": [
            idl.id(237173483),
        ],
        "A_absoluteLocation": [
            idl.id(126442216),
        ],
        "A_absoluteLocationAccuracy": [
            idl.id(29155565),
        ],
        "A_absoluteLocationCovariance": [
            idl.id(212606104),
        ],
        "A_angularVelocityAvailable": [
            idl.id(90633880),
        ],
        "A_angularVelocity": [
            idl.id(41912237),
        ],
        "A_angularVelocityAccuracy": [
            idl.id(259421538),
        ],
        "A_linearSpeedAvailable": [
            idl.id(17206948),
        ],
        "A_linearSpeed": [
            idl.id(79564538),
        ...
        "A_linearSpeedAccuracy": [
            idl.id(140233796),
        ],
        "A_radialVelocityAvailable": [
            idl.id(30429412),
        ],
        "A_radialVelocity": [
            idl.id(218586043),
        ],
        "A_radialVelocityAccuracy": [
            idl.id(12645927),
        ],
        "A_tangentialVelocityAvailable": [
            idl.id(206873348),
        ],
        "A_horizontalTangentialVelocity": [
            idl.id(195513788),
        ],
        "A_horizontalTangentialVelocityError": [
            idl.id(156366719),
        ],
        "A_verticalTangentialVelocity": [
            idl.id(194277054),
        ],
        "A_verticalTangentialVelocityError": [
            idl.id(201403017),
        ],
        "A_fieldOfViewAvailable": [
            idl.id(158004688),
        ],
        "A_fieldOfView": [
            idl.id(163011555),
...
class P_Tactical_Sensor_PSM_T_Physical_Parameters:
    ...
    A_relativeLocationCovariance: P_LDM_Common.T_CovariancePolar3D = field(
        default_factory=P_LDM_Common.T_CovariancePolar3D
    )
    ...
    A_inertialLocationCovariance: P_LDM_Common.T_CovariancePolar3D = field(
        default_factory=P_LDM_Common.T_CovariancePolar3D
    )
    A_absoluteLocationAvailable: bool = False
    A_absoluteLocation: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_absoluteLocationAccuracy: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_absoluteLocationCovariance: P_LDM_Common.T_Covariance_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Covariance_Coordinate3D
    )
    A_angularVelocityAvailable: bool = False
    A_angularVelocity: P_LDM_Common.T_Vector_3D = field(
        default_factory=P_LDM_Common.T_Vector_3D
    )
    A_angularVelocityAccuracy: P_LDM_Common.T_Vector_3D = field(
        default_factory=P_LDM_Common.T_Vector_3D
    )
    ...
    A_fieldOfView: P_Tactical_Sensor_PSM.T_Field_Of_View = field(
        default_factory=P_Tactical_Sensor_PSM.T_Field_Of_View
    )


P_Tactical_Sensor_PSM.T_Physical_Parameters = (
    P_Tactical_Sensor_PSM_T_Physical_Parameters
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Spatial_Info"),
    ],
    member_annotations={
        "A_physicalInfo": [
            idl.id(170544614),
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_ThreatData"),
    ],
    member_annotations={
        "A_threatID": [
            idl.id(241586546),
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_AronlodThreat"),
    ],
    member_annotations={
        "A_orientation": [
            idl.id(153422287),
...
class P_Tactical_Sensor_PSM_T_AronlodThreat:
    ...
    A_threatPencils: Sequence[P_Tactical_Sensor_PSM.T_ThreatData] = field(
        default_factory=list
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::T_Fusion_Polygon"),
    ],
    member_annotations={
        "A_type": [
            idl.id(60540847),
...
class P_Tactical_Sensor_PSM_T_Fusion_Polygon:
    A_type: P_LDM_Common.T_RegularString = field(
        default_factory=P_LDM_Common.T_RegularString
    )
    A_classification: P_LDM_Common.T_RegularString = field(
        default_factory=P_LDM_Common.T_RegularString
    )
    A_activityState: P_LDM_Common.T_RegularString = field(
        default_factory=P_LDM_Common.T_RegularString
    )
    A_trackRelation: P_Tactical_Sensor_PSM.T_TrackRelation = (
        P_Tactical_Sensor_PSM.T_TrackRelation.L_TrackRelation_IN
    )
    A_generationTime: P_LDM_Common.T_DateTime = field(
        default_factory=P_LDM_Common.T_DateTime
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_detectionSizeSupport": [
            idl.id(83890616),
        ],
        "A_accuracySupport": [
            idl.id(114850561),
        ],
        "A_detectionThreatLevelSupport": [
            idl.id(79787413),
        ],
        "A_setDetectorStateSupport": [
            idl.id(5997863),
        ],
        "A_videoDetectorSupport": [
            idl.id(203143827),
        ],
        "A_snapshotSupport": [
            idl.id(126899836),
        ...
        "A_maxNumberOfDetectionLocations": [
            idl.id(192960657),
        ],
        "A_inertialLocationSupport": [
            idl.id(176554836),
        ],
    },
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_sensorCurrentStatus": [
            idl.id(219859602),
        ],
        "A_falseAlarmProbability": [
            idl.id(3141405),
        ],
        "A_detectionProbability": [
            idl.id(229637417),
        ],
        "A_sensitivityLevel": [
            idl.id(175470000),
...
class P_Tactical_Sensor_PSM_C_Tactical_Sensor:
    ...
    A_sensorCurrentStatus: P_LDM_Common.T_EnabledState = (
        P_LDM_Common.T_EnabledState.L_EnabledState_ENABLED
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor_Video"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Tactical_Sensor_PSM_C_Tactical_Sensor_Video:
    ...
    A_processedVideoStreams: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )


P_Tactical_Sensor_PSM.C_Tactical_Sensor_Video = (
    P_Tactical_Sensor_PSM_C_Tactical_Sensor_Video
)
...
@idl.struct(
    ...
    member_annotations={
        ...
        "A_detectionClassification": [
            idl.id(85099305),
        ],
        "A_detectionClassScore": [
            idl.id(76917289),
        ],
        "A_detectionForceType": [
            idl.id(180790050),
        ],
        "A_detectionThreatStatus": [
            idl.id(223270006),
        ],
        "A_interception": [
            idl.id(115597617),
...
class P_Tactical_Sensor_PSM_C_Detection:
    ...
    A_detectionClassification: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    ...
    A_type: P_Tactical_Sensor_PSM.T_DetectionType = (
        P_Tactical_Sensor_PSM.T_DetectionType.L_DetectionType_DETECTION
    )
    A_lifeSpan: P_LDM_Common.T_Duration = field(default_factory=P_LDM_Common.T_Duration)
    A_priority: idl.int16 = 0
    A_trajectoryType: P_Tactical_Sensor_PSM.T_Trajectory = (
        P_Tactical_Sensor_PSM.T_Trajectory.L_Trajectory_UNKNOWN
    )
    A_method: Sequence[P_Tactical_Sensor_PSM.T_Sensing_Method] = field(
        default_factory=list
    )
    A_spatialParametersAvailable: bool = False
    A_spatialInfo: P_Tactical_Sensor_PSM.T_Spatial_Info = field(
        default_factory=P_Tactical_Sensor_PSM.T_Spatial_Info
    )
    ...
    A_detectionMethods: Optional[Sequence[P_Tactical_Sensor_PSM.T_DetectingMethod]] = (
        None
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_Merged"),
    ],
    member_annotations={
...
class P_Tactical_Sensor_PSM_C_Detection_Merged(P_Tactical_Sensor_PSM.C_Detection):
    A_sourceDetectionsID: Sequence[P_Tactical_Sensor_PSM.T_Detection_Unique_Id] = field(
        default_factory=list
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_Split"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Tactical_Sensor_PSM_C_Detection_Split:
    ...
    A_newDetectionsID: Sequence[P_Tactical_Sensor_PSM.T_Detection_Unique_Id] = field(
        default_factory=list
    )
    A_sourceDetectionsID: P_Tactical_Sensor_PSM.T_Detection_Unique_Id = field(
        default_factory=P_Tactical_Sensor_PSM.T_Detection_Unique_Id
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_Radar"),
    ],
    member_annotations={
        "A_detectionMode": [
            idl.id(82681813),
...
class P_Tactical_Sensor_PSM_C_Detection_Radar(P_Tactical_Sensor_PSM.C_Detection):
    A_detectionMode: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_Optronics"),
    ],
    member_annotations={
        "A_opticalErrorRadius": [
            idl.id(38790974),
        ],
        "A_absoluteDirectionAvailable": [
            idl.id(57211100),
        ],
        "A_sensorLOS": [
            idl.id(139547978),
        ...
        "A_videoDataAvailable": [
            idl.id(35928540),
        ],
        "A_videoStreamSourceID": [
            idl.id(152966567),
        ],
        "A_detectionCenterVideoLocation": [
            idl.id(83507131),
        ],
        "A_detectionSizeOnVideo": [
            idl.id(99643024),
        ],
        "A_detectionVideoAccuracy": [
            idl.id(216440692),
        ],
    },
)
class P_Tactical_Sensor_PSM_C_Detection_Optronics(P_Tactical_Sensor_PSM.C_Detection):
    ...
    A_videoStreamSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_Aps"),
    ],
    member_annotations={
        "A_timeToGo": [
            idl.id(16001726),
...
class P_Tactical_Sensor_PSM_C_Detection_Aps(P_Tactical_Sensor_PSM.C_Detection):
    ...
    A_threatFamily: P_Tactical_Sensor_PSM.T_ThreatFamily = (
        P_Tactical_Sensor_PSM.T_ThreatFamily.L_ThreatFamily_UNKNOWN
    )
    A_threatAronlod: Optional[P_Tactical_Sensor_PSM.T_AronlodThreat] = None
    A_actionStatus: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_threatHitPoint: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_threatRefinementInfo: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_ElectronicWarfare"),
    ],
    member_annotations={
        "A_tbdField": [
            idl.id(267696504),
...
class P_Tactical_Sensor_PSM_C_Detection_ElectronicWarfare(
    P_Tactical_Sensor_PSM.C_Detection
):
    A_tbdField: idl.int16 = 0


P_Tactical_Sensor_PSM.C_Detection_ElectronicWarfare = (
    P_Tactical_Sensor_PSM_C_Detection_ElectronicWarfare
)
...
class P_Tactical_Sensor_PSM_C_Snapshot:
    ...
    A_format: P_LDM_Common.T_VeryShortString = field(
        default_factory=P_LDM_Common.T_VeryShortString
    )
    A_snapshot: Sequence[idl.uint8] = field(
        default_factory=idl.array_factory(idl.uint8)
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_C4I"),
    ],
    member_annotations={
        "A_reportedPolygon": [
            idl.id(262049984),
...
class P_Tactical_Sensor_PSM_C_Detection_C4I(P_Tactical_Sensor_PSM.C_Detection):
    A_reportedPolygon: P_Tactical_Sensor_PSM.T_Polygon_Point = field(
        default_factory=P_Tactical_Sensor_PSM.T_Polygon_Point
    )
    A_idC4i: P_LDM_Common.T_Uuid = field(default_factory=P_LDM_Common.T_Uuid)
    A_polygonType: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_incrimination: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_inTraining: bool = False
    A_missionContext: P_LDM_Common.T_RegularString = field(
        default_factory=P_LDM_Common.T_RegularString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Detection_Fusion"),
    ],
    member_annotations={
        "A_detectionFusedUniqueID": [
            idl.id(188817672),
        ],
        "A_polygon": [
            idl.id(107617462),
...
class P_Tactical_Sensor_PSM_C_Detection_Fusion(P_Tactical_Sensor_PSM.C_Detection):
    A_detectionFusedUniqueID: P_LDM_Common.T_Uuid = field(
        default_factory=P_LDM_Common.T_Uuid
    )
    A_polygon: P_Tactical_Sensor_PSM.T_Fusion_Polygon = field(
        default_factory=P_Tactical_Sensor_PSM.T_Fusion_Polygon
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_C4I_Entity"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_entityClassification": [
            idl.id(216803846),
        ],
        "A_entityForceType": [
            idl.id(197087151),
        ],
        "A_entityThreatStatus": [
            idl.id(257735410),
        ],
        "A_interception": [
            idl.id(115597617),
...
class P_Tactical_Sensor_PSM_C_C4I_Entity:
    ...
    A_entityClassification: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_entityForceType: P_Tactical_Sensor_PSM.T_IFFCategory = (
        P_Tactical_Sensor_PSM.T_IFFCategory.L_IFFCategory_UNKNOWN
    )
    A_entityThreatStatus: P_Tactical_Sensor_PSM.T_EngagementStatus = (
        P_Tactical_Sensor_PSM.T_EngagementStatus.L_EngagementStatus_UNKNOWN
    )
    A_interception: P_Tactical_Sensor_PSM.T_Interception = (
        P_Tactical_Sensor_PSM.T_Interception.L_Interception_UNKNOWN
    )
    A_entityStatus: P_Tactical_Sensor_PSM.T_DetectionState = (
        P_Tactical_Sensor_PSM.T_DetectionState.L_DetectionState_NONE
    )
    A_method: Sequence[P_Tactical_Sensor_PSM.T_Sensing_Method] = field(
        default_factory=list
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor_Enable_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Tactical_Sensor_PSM.C_Tactical_Sensor_Enable_Cmd = (
    P_Tactical_Sensor_PSM_C_Tactical_Sensor_Enable_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor_Disable_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Tactical_Sensor_PSM.C_Tactical_Sensor_Disable_Cmd = (
    P_Tactical_Sensor_PSM_C_Tactical_Sensor_Disable_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor_AssignVideoStream_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Tactical_Sensor_PSM_C_Tactical_Sensor_AssignVideoStream_Cmd:
    ...
    A_assignedVideoStreams: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )


P_Tactical_Sensor_PSM.C_Tactical_Sensor_AssignVideoStream_Cmd = (
    P_Tactical_Sensor_PSM_C_Tactical_Sensor_AssignVideoStream_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensor_Sector_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Tactical_Sensor_PSM.C_Tactical_Sensor_Sector_Cmd = (
    P_Tactical_Sensor_PSM_C_Tactical_Sensor_Sector_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Tactical_Sensor_PSM::C_Tactical_Sensitivity_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Tactical_Sensor_PSM.C_Tactical_Sensitivity_Cmd = (
    P_Tactical_Sensor_PSM_C_Tactical_Sensitivity_Cmd
)
