...
@idl.struct(
    ...
    member_annotations = {
        'A_transmitRF': [idl.id(36088711), ],
        'A_ant1status': [idl.id(158624287), ],
        'A_ant2status': [idl.id(4316863), ],
        'A_ant3status': [idl.id(100586280), ],
        'A_ant4status': [idl.id(176791672), ],
    }
)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Radar_PSM::C_Radar_System_Specification")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_rangeSupport': [idl.id(8397463), ],
        'A_targetSizeSupport': [idl.id(32294457), ],
        'A_accuracySupport': [idl.id(114850561), ],
        'A_setDetectorStateSupport': [idl.id(5997863), ],
        'A_snapshotSupport': [idl.id(126899836), ],
        'A_linearInstallationOffset': [idl.id(82849345), ],
        'A_rotationalInstallationOffset': [idl.id(69427824), ],
        'A_rcsReductionSupport': [idl.id(193017008), ],
    }
)
class P_Radar_PSM_C_Radar_System_Specification:
    ...
    A_linearInstallationOffset: P_LDM_Common.T_LinearOffset = field(default_factory = P_LDM_Common.T_LinearOffset)
    A_rotationalInstallationOffset: P_LDM_Common.T_RotationalOffset = field(default_factory = P_LDM_Common.T_RotationalOffset)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Radar_PSM::C_Unified_Radar_Status")],
    member_annotations = {
        'A_state': [idl.id(90057368), ],
        'A_missionCategory': [idl.id(179661941), ],
        'A_tx': [idl.id(230735362), ],
        'A_freqIndex': [idl.id(204327783), ],
        'A_searchStatus': [idl.id(178074502), ],
    }
)
class P_Radar_PSM_C_Unified_Radar_Status(P_Radar_PSM.C_Radar_Status):
    ...
    A_missionCategory: P_Radar_PSM.T_MissionPurpose = P_Radar_PSM.T_MissionPurpose.L_MissionPurpose_MISSION_1
    A_tx: bool = False
    A_freqIndex: idl.int32 = 0
    A_searchStatus: P_Radar_PSM.T_SearchRadarStatus = field(default_factory = P_Radar_PSM.T_SearchRadarStatus)
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_installStatus': [idl.id(246399055), ],
        'A_bitInProcess': [idl.id(96571324), ],
    }
)
class P_Radar_PSM_C_Maintenance_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_installStatus: P_Radar_PSM.T_InstallStatus = P_Radar_PSM.T_InstallStatus.L_InstallStatus_NONE
    A_bitInProcess: bool = False

P_Radar_PSM.C_Maintenance_Status = P_Radar_PSM_C_Maintenance_Status

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Radar_PSM::C_Radar_System_Target_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_request': [idl.id(4951193), ],
        'A_mtg': [idl.id(258043443), ],
        'A_sPriority': [idl.id(16652445), ],
        'A_direction': [idl.id(4705490), ],
        'A_doppler': [idl.id(227270197), ],
    }
)
class P_Radar_PSM_C_Radar_System_Target_Cmd:
    ...
    A_direction: P_LDM_Common.T_CoordinatePolar3D = field(default_factory = P_LDM_Common.T_CoordinatePolar3D)
    A_doppler: float = 0.0

P_Radar_PSM.C_Radar_System_Target_Cmd = P_Radar_PSM_C_Radar_System_Target_Cmd

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Radar_PSM::C_Radar_System_MissionDef_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_rdrId': [idl.id(122259186), ],
        'A_state': [idl.id(90057368), ],
        'A_missionCategory': [idl.id(179661941), ],
        'A_tx': [idl.id(230735362), ],
        'A_freqIndex': [idl.id(204327783), ],
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Radar_PSM::C_Radar_Platform_Mdp_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_antenaId': [idl.id(135420166), ],
        'A_antenaType': [idl.id(62992772), ],
...
class P_Radar_PSM_C_Radar_Platform_Mdp_Cmd:
    ...
    A_referenceNum: idl.int32 = 0
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_antenaId: P_Radar_PSM.T_AntenaLocation = P_Radar_PSM.T_AntenaLocation.L_AntenaLocation_FORWARD_RIGHT
    A_antenaType: P_Radar_PSM.T_AntenaType = P_Radar_PSM.T_AntenaType.L_AntenaType_M_TYPE
