...
class P_Video_PSM_T_Video_Input:
    ...
    A_channelDescription: P_LDM_Common.T_ShortString = field(
...
class P_Video_PSM_T_Video_Output:
    ...
    A_displayDescription: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Source_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_videoRoutingSupport": [
            idl.id(235635679),
        ],
        "A_turnVideoOnOffSupport": [
            idl.id(87475786),
        ],
    },
)
class P_Video_PSM_C_Video_Source_Specification:
    ...
    A_providedVideoStream: Sequence[P_LDM_Common.T_Identifier] = field(
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Routing_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Video_Routing_Specification:
    ...
    A_inputVideoChannels: Sequence[P_Video_PSM.T_Video_Input] = field(
        default_factory=list
    )
    A_outputVideoChannels: Sequence[P_Video_PSM.T_Video_Output] = field(
        default_factory=list
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Media_Capture_Service_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_capturedVideoStream": [
            idl.id(109310280),
        ],
        "A_captureFrameSupported": [
            idl.id(14591882),
        ],
        "A_captureVideoSupported": [
            idl.id(217319292),
        ],
        "A_cachedDuration": [
            idl.id(145225100),
...
class P_Video_PSM_C_Media_Capture_Service_Specification:
    ...
    A_capturedVideoStream: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
P_Video_PSM.C_Media_Capture_Service_Specification = (
    P_Video_PSM_C_Media_Capture_Service_Specification
)
...
class P_Video_PSM_C_Video_Routing:
    ...
    A_inputVideo: P_Video_PSM.T_Video_Input = field(
        default_factory=P_Video_PSM.T_Video_Input
    )
    A_outputVideo: P_Video_PSM.T_Video_Output = field(
        default_factory=P_Video_PSM.T_Video_Output
    )
...
class P_Video_PSM_C_Rtsp:
    ...
    A_uri: P_LDM_Common.T_MediumString = field(
        default_factory=P_LDM_Common.T_MediumString
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Stream_Specification"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
        ...
        "A_focusContinuousSupport": [
            idl.id(190923565),
        ],
        "A_gainSupport": [
            idl.id(155128789),
        ],
        "A_gainContinuousSupport": [
            idl.id(30143047),
        ],
        "A_levelSupport": [
            idl.id(18472892),
        ],
        "A_levelContinuousSupport": [
            idl.id(132077521),
        ],
        "A_polaritySupport": [
            idl.id(217684417),
        ...
        "A_reticleOnVideoSupport": [
            idl.id(233940577),
        ],
        "A_reticleColorControlSupport": [
            idl.id(124485842),
        ],
        "A_fusionStreamsSupport": [idl.id(37782892), idl.bound(10)],
        "A_markerVisibleSupport": [
            idl.id(130175417),
        ],
        "A_digitalImageStablizationSupport": [
            idl.id(15230058),
        ],
        "A_nucSupport": [
            idl.id(154515907),
...
class P_Video_PSM_C_Video_Stream_Specification:
    ...
    A_fusionStreamsSupport: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_markerVisibleSupport: bool = False
    A_digitalImageStablizationSupport: bool = False
    A_nucSupport: bool = False
    A_streamResolution: P_LDM_Common.T_Resolution = field(
        default_factory=P_LDM_Common.T_Resolution
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Stream_Zoom_Support"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Video_Stream_Zoom_Support:
    ...
    A_discreteFovSupport: P_Video_PSM.T_FieldOfViewArray = field(
        default_factory=P_Video_PSM.T_FieldOfViewArray
    )
...
class P_Video_PSM_C_Zoom:
    ...
    A_zoom: float = 0.0
    A_fov: float = 0.0
    A_zoomState: P_Video_PSM.T_ContinuousState = (
        P_Video_PSM.T_ContinuousState.L_ContinuousState_STATIC
    )
...
class P_Video_PSM_C_Focus:
    ...
    A_focusState: P_Video_PSM.T_ContinuousState = (
        P_Video_PSM.T_ContinuousState.L_ContinuousState_STATIC
    )
...
class P_Video_PSM_C_Polarity:
    ...
    A_polarityState: P_Video_PSM.T_Polarity = (
        P_Video_PSM.T_Polarity.L_Polarity_WHITE_HOT
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Stream_Level_Support"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Level:
    ...
    A_levelState: P_Video_PSM.T_ContinuousState = (
        P_Video_PSM.T_ContinuousState.L_ContinuousState_STATIC
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Stream_Gain_Support"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Gain:
    ...
    A_gainState: P_Video_PSM.T_ContinuousState = (
        P_Video_PSM.T_ContinuousState.L_ContinuousState_STATIC
    )
...
class P_Video_PSM_C_Emphasis:
    ...
    A_emphasisState: P_Video_PSM.T_Emphasis = (
        P_Video_PSM.T_Emphasis.L_Emphasis_SCENE_PLUS
    )
...
class P_Video_PSM_C_Fusion:
    ...
    A_fusionedStream: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Digital_Image_Stabilization"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Reticle_On_Video_State"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Reticle_On_Video_State:
    ...
    A_reticleColor: P_LDM_Common.T_VeryShortString = field(
...
class P_Video_PSM_C_NUC_State:
    ...
    A_streamNUCState: P_Video_PSM.T_NUC_State = (
        P_Video_PSM.T_NUC_State.L_NUC_State_NOT_DONE
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Stream_Position"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Video_Stream_Position:
    ...
    A_position: P_LDM_Common.T_PixelsVideoPosition = field(
        default_factory=P_LDM_Common.T_PixelsVideoPosition
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Stream_Relative_Position"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Video_Stream_Relative_Position:
    ...
    A_deviation: P_LDM_Common.T_PixelsVideoPosition = field(
        default_factory=P_LDM_Common.T_PixelsVideoPosition
    )
    A_fov: float = 0.0


P_Video_PSM.C_Video_Stream_Relative_Position = (
    P_Video_PSM_C_Video_Stream_Relative_Position
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Media_Captured_Event"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Media_Captured_Event:
    ...
    A_captureState: P_Video_PSM.T_CaptureMode = (
        P_Video_PSM.T_CaptureMode.L_CaptureMode_IDLE
    )
    A_mediaPath: P_LDM_Common.T_MediumString = field(
        default_factory=P_LDM_Common.T_MediumString
    )
    A_fileName: P_LDM_Common.T_MediumString = field(
        default_factory=P_LDM_Common.T_MediumString
    )
    A_capturedStreamID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Media_Capture_Service"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Media_Capture_Service:
    ...
    A_requestGuid: P_LDM_Common.T_Uuid = field(default_factory=P_LDM_Common.T_Uuid)
    A_currentlyCapturedStreamID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_workingMode: P_Video_PSM.T_CaptureMode = (
        P_Video_PSM.T_CaptureMode.L_CaptureMode_IDLE
    )
    A_processState: P_LDM_Common.T_EnabledState = (
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Zoom_SetContinuousZoom_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Focus_SetAutoState_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Focus_SetContinuousFocus_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Polarity_InvertPolarity_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Level_SetAutoState_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Level_SetContinuousLevel_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Level_NudgeLevel_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Gain_SetAutoState_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Gain_SetContinuousGain_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Emphasis_NextEmphasis_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Emphasis_PrevEmphasis_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Panorama_StartPanorama_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Panorama_StartPanorama_Cmd:
    ...
    A_videoStreamID_Ref: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_fov: float = 0.0
    A_boundaryPoints: Sequence[P_LDM_Common.T_RotationalPosition] = field(
        default_factory=list
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Panorama_StopPanorama_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Source_TurnVideoOn_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Video_Source_TurnVideoOff_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Video_PSM.C_Video_Source_TurnVideoOff_Cmd = (
    P_Video_PSM_C_Video_Source_TurnVideoOff_Cmd
)
...
class P_Video_PSM_C_Fusion_TurnOn_Cmd:
    ...
    A_fusionRequestedStream: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Marker_Visible_TurnOn_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Marker_Visible_TurnOff_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Reticle_Color_Control_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Reticle_Color_Control_Cmd:
    ...
    A_reticleRequestedColor: P_Video_PSM.T_ReticleColor = (
        P_Video_PSM.T_ReticleColor.L_ReticleColor_BRIGHTER
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Emphasis_NeutralEmphasis_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Digital_Image_Stabilization_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Video_PSM.C_Digital_Image_Stabilization_Cmd = (
    P_Video_PSM_C_Digital_Image_Stabilization_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Turbulence_Action_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Reticle_On_Video_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Emphasis_SetEmphasis_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Video_PSM_C_Capture_Media_Cmd:
    ...
    A_selectedVideoStream: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Reticle_GetPosition_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Video_PSM::C_Reticle_SetColor_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
