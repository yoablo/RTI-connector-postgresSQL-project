...
class P_Mount_PSM_C_Mount_Specification:
    ...
    A_presetBringToPosSupport: P_Mount_PSM.T_PresetAnglesArray = field(
        default_factory=P_Mount_PSM.T_PresetAnglesArray
    )
    A_enslavingMountsSupport: Sequence[P_LDM_Common.T_Identifier] = field(
        default_factory=list
    )
    A_stabilizationModeSupport: Sequence[P_Mount_PSM.T_StabilizationMode] = field(
        default_factory=list
    )
    A_movementInhibitZoneSupport: bool = False
    A_preDefinedPositionsSupport: Sequence[P_Mount_PSM.T_PredefinedPosition] = field(
        default_factory=list
    )
...
class P_Mount_PSM_C_Rot_Mount:
    ...
    A_mountPosition: P_LDM_Common.T_RotationalPosition = field(
        default_factory=P_LDM_Common.T_RotationalPosition
    )
    A_absolutePosition: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_attitudeToNorthPosition: float = 0.0
    A_scanState: P_Mount_PSM.T_ProcessState = (
        P_Mount_PSM.T_ProcessState.L_ProcessState_OFF
    )
    A_bringToState: P_Mount_PSM.T_ProcessState = (
        P_Mount_PSM.T_ProcessState.L_ProcessState_OFF
    )
    A_bringToPreset: P_LDM_Common.T_RotationalPosition = field(
        default_factory=P_LDM_Common.T_RotationalPosition
    )
    A_enslavementMode: P_Mount_PSM.T_EnslavementMode = (
        P_Mount_PSM.T_EnslavementMode.L_EnslavementMode_INDEPENDENT
    )
    A_enslavedTo: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
    A_workMode: P_Mount_PSM.T_MountWorkMode = (
        P_Mount_PSM.T_MountWorkMode.L_MountWorkMode_INIT
    )
    A_lmcState: P_LDM_Common.T_OnOff = P_LDM_Common.T_OnOff.L_OnOff_ON
    A_stabilizationState: P_Mount_PSM.T_StabilizationMode = (
        P_Mount_PSM.T_StabilizationMode.L_StabilizationMode_MANUAL
    )
...
class P_Mount_PSM_C_Rot_Mount_Index:
    ...
    A_indexState: P_Mount_PSM.T_IndexProcessMode = (
        P_Mount_PSM.T_IndexProcessMode.L_IndexProcessMode_NOT_ACTIVE
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_Calibration_Status"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_Calibration_Status:
    ...
    A_calibrationState: P_Mount_PSM.T_CalibrationMode = (
        P_Mount_PSM.T_CalibrationMode.L_CalibrationMode_NONE
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Mount_Command_Response"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Boresight_Calibration_Response"),
    ],
    member_annotations={
        "A_enslavementMode": [
            idl.id(125824979),
...
class P_Mount_PSM_C_Boresight_Calibration_Response(
    P_Mount_PSM.C_Mount_Command_Response
):
    A_enslavementMode: P_LDM_Common.T_SightEnslavement_Mode = (
        P_LDM_Common.T_SightEnslavement_Mode.L_SightEnslavement_Mode_IDLE
    )


P_Mount_PSM.C_Boresight_Calibration_Response = (
    P_Mount_PSM_C_Boresight_Calibration_Response
)
...
class P_Mount_PSM_C_GS_ModeStatus:
    ...
    A_mode: P_Mount_PSM.T_MountSystem_Mode = (
        P_Mount_PSM.T_MountSystem_Mode.L_MountSystem_Mode_INIT
    )
...
class P_Mount_PSM_C_Mount_Limits_Status:
    ...
    A_sectorType: P_LDM_Common.T_ShortString = field(
        default_factory=P_LDM_Common.T_ShortString
    )
    A_sectorLimits: Sequence[P_LDM_Common.T_RotationalPosition] = field(
        default_factory=list
    )
    A_sectorAzRef: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_BringToRelative_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_BringToRelative_Cmd:
    ...
    A_relativePosition: P_LDM_Common.T_RotationalPosition = field(
        default_factory=P_LDM_Common.T_RotationalPosition
    )


P_Mount_PSM.C_Rot_Mount_BringToRelative_Cmd = (
    P_Mount_PSM_C_Rot_Mount_BringToRelative_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_BringTo_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_BringToPreset_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_BringToPreset_Cmd:
    ...
    A_preset: P_LDM_Common.T_RotationalPosition = field(
        default_factory=P_LDM_Common.T_RotationalPosition
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_BringToCyclic_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_EnslaveTo_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_EnslaveTo_Cmd:
    ...
    A_requestedEnslaveMode: P_Mount_PSM.T_EnslavementMode = (
        P_Mount_PSM.T_EnslavementMode.L_EnslavementMode_INDEPENDENT
    )
    A_enslaverMountID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_StartScanning_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_StopScanning_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_SetWorkMode_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_SetMaintenanceMode_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_SetMaintenanceMode_Cmd:
    ...
    A_maintMode: P_Mount_PSM.T_MaintenanceMode = (
        P_Mount_PSM.T_MaintenanceMode.L_MaintenanceMode_CALIBRATION
    )


P_Mount_PSM.C_Rot_Mount_SetMaintenanceMode_Cmd = (
    P_Mount_PSM_C_Rot_Mount_SetMaintenanceMode_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_SetCalibrationMode_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_SetCalibrationMode_Cmd:
    ...
    A_calibrationMode: P_Mount_PSM.T_CalibrationMode = (
        P_Mount_PSM.T_CalibrationMode.L_CalibrationMode_NONE
    )


P_Mount_PSM.C_Rot_Mount_SetCalibrationMode_Cmd = (
    P_Mount_PSM_C_Rot_Mount_SetCalibrationMode_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_StartStabilization_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Mount_PSM.C_Rot_Mount_StartStabilization_Cmd = (
    P_Mount_PSM_C_Rot_Mount_StartStabilization_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_StopStabilization_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
P_Mount_PSM.C_Rot_Mount_StopStabilization_Cmd = (
    P_Mount_PSM_C_Rot_Mount_StopStabilization_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_SetLmcState_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_Set_StabilizationMode_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_Set_StabilizationMode_Cmd:
    ...
    A_stabilizationMode: P_Mount_PSM.T_StabilizationMode = (
        P_Mount_PSM.T_StabilizationMode.L_StabilizationMode_MANUAL
    )


P_Mount_PSM.C_Rot_Mount_Set_StabilizationMode_Cmd = (
    P_Mount_PSM_C_Rot_Mount_Set_StabilizationMode_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Mount_Sight_Enslave_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Rot_Mount_BringToPredefindPosition_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
class P_Mount_PSM_C_Rot_Mount_BringToPredefindPosition_Cmd:
    ...
    A_position: P_Mount_PSM.T_PredefinedPosition = (
        P_Mount_PSM.T_PredefinedPosition.L_PredefinedPosition_LOAD
    )


P_Mount_PSM.C_Rot_Mount_BringToPredefindPosition_Cmd = (
    P_Mount_PSM_C_Rot_Mount_BringToPredefindPosition_Cmd
)
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_Mount_PSM::C_Mount_BringTo_Event_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
