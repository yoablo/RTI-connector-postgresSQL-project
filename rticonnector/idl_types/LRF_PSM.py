...
class P_LRF_PSM_C_LRF_Specification:
    ...
    A_lrfSourceID: P_LDM_Common.T_Identifier = field(
        default_factory=P_LDM_Common.T_Identifier
    )
...
class P_LRF_PSM_C_LRF_Measurement:
    ...
    A_rangeMeasurements: Sequence[P_LRF_PSM.T_MeasuredRange] = field(
        default_factory=list
    )
    A_rangeType: P_LRF_PSM.T_LRF_RangeType = (
        P_LRF_PSM.T_LRF_RangeType.L_LRF_RangeType_MANUAL
    )
    A_lasingStatus: P_LRF_PSM.T_LRF_LasingStatus = (
        P_LRF_PSM.T_LRF_LasingStatus.L_LRF_LasingStatus_NONE
    )
    A_rangeAccuracy: P_LRF_PSM.T_LRF_RangeAccuracy = (
        P_LRF_PSM.T_LRF_RangeAccuracy.L_LRF_RangeAccuracy_ACCURATE
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_LRF_PSM::C_LRF_Measurement_Extended"),
    ],
    member_annotations={
        "A_lasingLocation": [
            idl.id(91000504),
...
class P_LRF_PSM_C_LRF_Measurement_Extended(P_LRF_PSM.C_LRF_Measurement):
    A_lasingLocation: P_LDM_Common.T_Coordinate3D = field(
        default_factory=P_LDM_Common.T_Coordinate3D
    )
    A_lasingInitiator: P_LDM_Common.T_Operator = (
        P_LDM_Common.T_Operator.L_Operator_COMMANDER
    )
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_LRF_PSM::C_LRF_StartFiringLaser_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_LRF_PSM::C_LRF_StopFiringLaser_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
...
@idl.struct(
    type_annotations=[
        idl.mutable,
        idl.type_name("P_LRF_PSM::C_LRF_SetMinimalRange_Cmd"),
    ],
    member_annotations={
        "A_sourceID": [
            idl.key,
