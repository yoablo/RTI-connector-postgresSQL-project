...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_description': [idl.id(133777518), ],
        'A_priority': [idl.id(261701171), ],
    }
)
class P_Maintenance_PSM_T_Error:
    A_status: P_Maintenance_PSM.T_ErrorState = P_Maintenance_PSM.T_ErrorState.L_ErrorState_EXISTS
    A_description: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
...
@idl.struct(
    ...
    member_annotations = {
        'A_operation': [idl.id(127010964), ],
        'A_date': [idl.id(153874871), ],
        'A_status': [idl.id(207505413), ],
    }
)
class P_Maintenance_PSM_T_OperationDate:
    A_operation: P_Maintenance_PSM.T_MaintenanceOperation = P_Maintenance_PSM.T_MaintenanceOperation.L_MaintenanceOperation_IBIT
    A_date: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_status: P_Maintenance_PSM.T_OperationStatus = P_Maintenance_PSM.T_OperationStatus.L_OperationStatus_SUCCESS

P_Maintenance_PSM.T_OperationDate = P_Maintenance_PSM_T_OperationDate

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::T_ComponentVersion")],
    member_annotations = {
        'A_componentName': [idl.id(29316198), ],
        'A_version': [idl.id(10701666), ],
    }
)
class P_Maintenance_PSM_T_ComponentVersion:
    A_componentName: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::T_ComponentRotationalOffset")],
    member_annotations = {
        'A_componentDescription': [idl.id(249926398), ],
        'A_rotationalOffset': [idl.id(110560446), ],
    }
)
class P_Maintenance_PSM_T_ComponentRotationalOffset:
    A_componentDescription: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_rotationalOffset: P_LDM_Common.T_RotationalOffset = field(default_factory = P_LDM_Common.T_RotationalOffset)

P_Maintenance_PSM.T_ComponentRotationalOffset = P_Maintenance_PSM_T_ComponentRotationalOffset
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_errorID': [idl.key, idl.id(114815591), ],
        'A_errorData': [idl.id(114687765), ],
    }
)
class P_Maintenance_PSM_C_Error_Report:
    ...
    A_errorData: P_Maintenance_PSM.T_Error = field(default_factory = P_Maintenance_PSM.T_Error)

P_Maintenance_PSM.C_Error_Report = P_Maintenance_PSM_C_Error_Report

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_SystemTime_Update")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_time': [idl.id(234800211), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_alertID': [idl.key, idl.id(232587608), ],
        'A_alertData': [idl.id(195394565), ],
        'A_category': [idl.id(237999199), ],
    }
)
class P_Maintenance_PSM_C_Alert_Report:
    ...
    A_alertData: P_Maintenance_PSM.T_Error = field(default_factory = P_Maintenance_PSM.T_Error)
    A_category: P_Maintenance_PSM.T_AlertCategory = P_Maintenance_PSM.T_AlertCategory.L_AlertCategory_INFO
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_state': [idl.id(90057368), ],
    }
)
class P_Maintenance_PSM_C_System_State:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_state: P_Maintenance_PSM.T_OperationalStates = P_Maintenance_PSM.T_OperationalStates.L_OperationalStates_OPERATION
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_moduleName': [idl.id(224125214), ],
        'A_status': [idl.id(207505413), ],
        'A_fieldID': [idl.id(191725964), ],
    }
)
class P_Maintenance_PSM_C_Module_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_moduleName: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_status: P_Maintenance_PSM.T_ModulePropriety = P_Maintenance_PSM.T_ModulePropriety.L_ModulePropriety_PROPER
    A_fieldID: Optional[idl.uint32] = None

P_Maintenance_PSM.C_Module_Status = P_Maintenance_PSM_C_Module_Status

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Maintenance_Operation_Response")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_maintOperation': [idl.id(267210651), ],
        'A_operationStatus': [idl.id(87817366), ],
        'A_reason': [idl.id(244844774), ],
        'A_progress': [idl.id(4719679), ],
    }
)
class P_Maintenance_PSM_C_Maintenance_Operation_Response:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_maintOperation: P_Maintenance_PSM.T_MaintenanceOperation = P_Maintenance_PSM.T_MaintenanceOperation.L_MaintenanceOperation_IBIT
    A_operationStatus: P_Maintenance_PSM.T_OperationStatus = P_Maintenance_PSM.T_OperationStatus.L_OperationStatus_SUCCESS
    A_reason: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_progress: idl.int16 = 0

P_Maintenance_PSM.C_Maintenance_Operation_Response = P_Maintenance_PSM_C_Maintenance_Operation_Response

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Maintenance_Operation_Dates")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_numberOfOperations': [idl.id(174958052), ],
...
class P_Maintenance_PSM_C_Maintenance_Operation_Dates:
    ...
    A_operationDates: Sequence[P_Maintenance_PSM.T_OperationDate] = field(default_factory = list)

P_Maintenance_PSM.C_Maintenance_Operation_Dates = P_Maintenance_PSM_C_Maintenance_Operation_Dates

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Resource_Specification_Extended")],
    member_annotations = {
        'A_softwareSubversions': [idl.id(74368763), idl.bound(30)],
        'A_hardwareSubversions': [idl.id(206306151), idl.bound(30)],
    }
)
class P_Maintenance_PSM_C_Resource_Specification_Extended(P_Maintenance_PSM.C_Resource_Specification):
    A_softwareSubversions: Sequence[P_Maintenance_PSM.T_ComponentVersion] = field(default_factory = list)
    A_hardwareSubversions: Sequence[P_Maintenance_PSM.T_ComponentVersion] = field(default_factory = list)

P_Maintenance_PSM.C_Resource_Specification_Extended = P_Maintenance_PSM_C_Resource_Specification_Extended

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Alert_Report_Extended")],
    member_annotations = {
        'A_reportedEntity': [idl.id(40946440), ],
        'A_safetyIndication': [idl.id(195320259), ],
        'A_report': [idl.id(17868329), ],
    }
)
class P_Maintenance_PSM_C_Alert_Report_Extended(P_Maintenance_PSM.C_Alert_Report):
    A_reportedEntity: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_safetyIndication: P_Maintenance_PSM.T_SafetyLevel = P_Maintenance_PSM.T_SafetyLevel.L_SafetyLevel_NONE
    A_report: P_LDM_Common.T_LongString = field(default_factory = P_LDM_Common.T_LongString)

P_Maintenance_PSM.C_Alert_Report_Extended = P_Maintenance_PSM_C_Alert_Report_Extended

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Error_Report_Extended")],
    member_annotations = {
        'A_reportedEntity': [idl.id(40946440), ],
        'A_safetyIndication': [idl.id(195320259), ],
        'A_transcript': [idl.id(130272259), ],
    }
)
class P_Maintenance_PSM_C_Error_Report_Extended(P_Maintenance_PSM.C_Error_Report):
    A_reportedEntity: P_LDM_Common.T_ShortString = field(default_factory = P_LDM_Common.T_ShortString)
    A_safetyIndication: P_Maintenance_PSM.T_SafetyLevel = P_Maintenance_PSM.T_SafetyLevel.L_SafetyLevel_NONE
    A_transcript: P_LDM_Common.T_LongString = field(default_factory = P_LDM_Common.T_LongString)

P_Maintenance_PSM.C_Error_Report_Extended = P_Maintenance_PSM_C_Error_Report_Extended

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Rotational_Installation_Offsets")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_subjectID': [idl.key, idl.id(28152324), ],
        'A_numberOfModules': [idl.id(213065396), ],
...
class P_Maintenance_PSM_C_Rotational_Installation_Offsets:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_subjectID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_numberOfModules: idl.uint8 = 0
    A_modulesOffsets: Sequence[P_Maintenance_PSM.T_ComponentRotationalOffset] = field(default_factory = list)

P_Maintenance_PSM.C_Rotational_Installation_Offsets = P_Maintenance_PSM_C_Rotational_Installation_Offsets

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_RequestIBIT_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
...
class P_Maintenance_PSM_C_AlertAck_Cmd:
    ...
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_alertID: idl.uint32 = 0
    A_actorAck: P_Maintenance_PSM.T_AcknowledgementType = P_Maintenance_PSM.T_AcknowledgementType.L_AcknowledgementType_ACCEPTED

P_Maintenance_PSM.C_AlertAck_Cmd = P_Maintenance_PSM_C_AlertAck_Cmd

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_SetCalibrationMode_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
...
class P_Maintenance_PSM_C_SetCalibrationMode_Cmd:
    ...
    A_referenceNum: idl.int32 = 0
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_calibrationMode: P_Maintenance_PSM.T_CalibrationMode = P_Maintenance_PSM.T_CalibrationMode.L_CalibrationMode_OPTRONICS

P_Maintenance_PSM.C_SetCalibrationMode_Cmd = P_Maintenance_PSM_C_SetCalibrationMode_Cmd

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Set_MaintenanceMode_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_maintenanceMode': [idl.id(116800824), ],
    }
)
class P_Maintenance_PSM_C_Set_MaintenanceMode_Cmd:
    ...
    A_referenceNum: idl.int32 = 0
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_maintenanceMode: P_Maintenance_PSM.T_MaintenanceMode = P_Maintenance_PSM.T_MaintenanceMode.L_MaintenanceMode_IBIT

P_Maintenance_PSM.C_Set_MaintenanceMode_Cmd = P_Maintenance_PSM_C_Set_MaintenanceMode_Cmd

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Maintenance_Operation_Activate_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
...
P_Maintenance_PSM.C_Maintenance_Operation_Activate_Cmd = P_Maintenance_PSM_C_Maintenance_Operation_Activate_Cmd

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_Maintenance_PSM::C_Set_Operational_State_Cmd")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_recipientID': [idl.key, idl.id(214190224), ],
        'A_referenceNum': [idl.id(249600164), ],
...
P_Maintenance_PSM.C_Set_Operational_State_Cmd = P_Maintenance_PSM_C_Set_Operational_State_Cmd
