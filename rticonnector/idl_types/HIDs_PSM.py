...
@idl.struct(
    ...
    member_annotations = {
        'A_sequentialNumber': [idl.id(161977479), ],
        'A_xVal': [idl.id(64568935), ],
        'A_yVal': [idl.id(218721993), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        'A_sequentialNumber': [idl.id(161977479), ],
        'A_isShapingSupported': [idl.id(27651834), ],
    }
)
...
@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_HIDs_PSM::T_JoysticksSpecification")],
    member_annotations = {
        'A_numberOfJoysticks': [idl.id(99592372), ],
        'A_joystickParams': [idl.id(199031102), idl.bound(16)],
    }
)
class P_HIDs_PSM_T_JoysticksSpecification:
    A_numberOfJoysticks: idl.uint8 = 0
    A_joystickParams: Sequence[P_HIDs_PSM.T_JoystickParams] = field(default_factory = list)
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_joysticksSpecification': [idl.id(159321212), ],
        'A_numberOfInputSwitches': [idl.id(262096556), ],
        'A_numberOfOutputSwitches': [idl.id(224272178), ],
        'A_inputSwitchesDescriptors': [idl.id(227179339), ],
        'A_outputSwitchesDescriptors': [idl.id(182788638), ],
    }
)
class P_HIDs_PSM_C_HID_Specification:
    ...
    A_joysticksSpecification: P_HIDs_PSM.T_JoysticksSpecification = field(default_factory = P_HIDs_PSM.T_JoysticksSpecification)
    A_numberOfInputSwitches: idl.uint8 = 0
    A_numberOfOutputSwitches: idl.uint8 = 0
    A_inputSwitchesDescriptors: P_HIDs_PSM.T_SwitchesDescription = field(default_factory = P_HIDs_PSM.T_SwitchesDescription)
    A_outputSwitchesDescriptors: P_HIDs_PSM.T_SwitchesDescription = field(default_factory = P_HIDs_PSM.T_SwitchesDescription)
...
class P_HIDs_PSM_C_Joysticks_Raw_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_listOfJoystickRawStatus: Sequence[P_HIDs_PSM.T_JoystickRawData] = field(default_factory = list)

P_HIDs_PSM.C_Joysticks_Raw_Status = P_HIDs_PSM_C_Joysticks_Raw_Status

@idl.struct(
    type_annotations = [idl.mutable, idl.type_name("P_HIDs_PSM::C_Joysticks_Shaped_Status")],
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
...
class P_HIDs_PSM_C_Joysticks_Shaped_Status:
    A_sourceID: P_LDM_Common.T_Identifier = field(default_factory = P_LDM_Common.T_Identifier)
    A_timeOfDataGeneration: P_LDM_Common.T_DateTime = field(default_factory = P_LDM_Common.T_DateTime)
    A_listOfJoystickShapedStatus: Sequence[P_HIDs_PSM.T_JoystickShapedData] = field(default_factory = list)
...
@idl.struct(
    ...
    member_annotations = {
        'A_sourceID': [idl.key, idl.id(118386796), ],
        'A_timeOfDataGeneration': [idl.id(234062147), ],
        'A_inputSwitches': [idl.id(153847315), ],
        'A_inputSwitchesValidity': [idl.id(200199832), ],
    }
)
...
@idl.struct(
    ...
    member_annotations = {
        ...
        'A_switches': [idl.id(56251523), ],
        'A_switchesMask': [idl.id(55233567), ],
    }
)
